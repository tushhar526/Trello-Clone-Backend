...
urlpatterns = [
    ...
    path("auth/setting/", UserSettingsView.as_view(), name="user_setting_URL"),
    path("auth/reset-password/", ResetPasswordAPI.as_view(), name="reset_password_URL"),
    path("auth/magic-login/", MagicLoginAPI.as_view(), name="magic_login_URL"),
