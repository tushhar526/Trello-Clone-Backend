...
class StageModel(models.Model): 
    ...
    workspace = models.ForeignKey(
        "workspaces.WorkspaceModel", on_delete=models.CASCADE, related_name="stages"
    )
    name = models.CharField(max_length=50, blank=False, null=False)
    description = models.TextField(blank=True, null=True)  # Changed from color
...
class TaskModel(models.Model):
    ...
    stage = models.ForeignKey(
        StageModel, on_delete=models.SET_NULL, null=True, related_name="tasks"
    )
